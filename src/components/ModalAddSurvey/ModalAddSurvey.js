...
class ModalAddSurvey extends Component {
    constructor(props) {
        super(props);
        this.state = {
            topic: '',
    ...
    onSubmit = () => {
        callApi('surveys/create', 'POST', this.state).then(res => {
            this.props.onAddSurvey((res.data));
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                ...
                                <h4 className="modal-title" id="exampleModalLabel">Thêm phiên khảo sát</h4>
                            </div>
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        onAddSurvey: (data) => {
            dispatch(actions.actAddSurvey(data));
        }
    }
}
export default connect(mapStateToProps, mapDispatchToProps)(ModalAddSurvey);
